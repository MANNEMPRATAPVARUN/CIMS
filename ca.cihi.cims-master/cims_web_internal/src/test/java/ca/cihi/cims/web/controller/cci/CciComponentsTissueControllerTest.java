...
public class CciComponentsTissueControllerTest {
	...
	private final CciComponentsTissueController controller = new CciComponentsTissueController();
	...
	public void testRead() throws Exception {
		...
		when(
				auxService.getComponentsSQL(eq("CCI"), eq(comps.getVersionCode()), eq(comps.getSection()), eq(comps
						.getStatus()), eq("Tissue"), eq("TissueToSectionCPV"))).thenReturn(values);
		mockMvc.perform(get("/tissueComponents") //
