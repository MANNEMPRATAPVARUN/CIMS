...
public class ReviewGroupCompiledResponsesReportIndexView extends CIMSBaseExcelView {

	public ReviewGroupCompiledResponsesReportIndexView(){
		super();
		setUrl(TEMPLATE_URL);
	}
	...
	private static final String TEMPLATE_URL = "classpath:/report/ReviewGroupCompiledResponsesIndexReportTemplate";

	private static final String SCHEMA_URL = "/report/ReviewGroupCompiledResponsesIndexReportSchema.xml";

	public static final String REPORT_FILE_NAME = "ReviewGroupCompiledResponsesIndexReport.xls";
