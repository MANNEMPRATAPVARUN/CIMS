...
public class ReviewGroupOutboundQuestionsReportTabularView extends CIMSBaseExcelView {

	public ReviewGroupOutboundQuestionsReportTabularView(){
		super();
		setUrl(TEMPLATE_URL);
	}
	...
	private static final String TEMPLATE_URL = "classpath:/report/ReviewGroupOutboundQuestionsTabularReportTemplate";

	private static final String SCHEMA_URL = "/report/ReviewGroupOutboundQuestionsTabularReportSchema.xml";

	public static final String REPORT_FILE_NAME = "ReviewGroupOutboundQuestionsTabularReport.xls";
