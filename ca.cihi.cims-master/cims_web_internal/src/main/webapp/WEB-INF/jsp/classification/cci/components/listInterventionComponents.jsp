...
<script type="text/javascript">
	...
	function addNewDefinition(alertText) {
		var iframe = $("#newDiagramIframe");
	    iframe.attr("src", iframe.data("src"));
		$("#newDefinitionDialog").dialog("open");
	}
...
<div class="content">
	...
	<input type='text' id='componentModelType' value='intervention' style="display: none;"/>
...
<div id="definitionDialog" style="display:none; overflow:hidden;" title="Dialog Title">
	<iframe name="diagramIframe" id="diagramIframe"
		data-src="intComponents/diagram.htm?"		
		src="about:blank" width="100%" height="100%"></iframe>
</div>

<div id="newDefinitionDialog" style="display:none; overflow:hidden;" title="Dialog Title">
	<iframe name="newDiagramIframe" id="newDiagramIframe"
		data-src="intComponents/newDefinition.htm"		
		src="about:blank" width="100%" height="100%"></iframe>
</div>
