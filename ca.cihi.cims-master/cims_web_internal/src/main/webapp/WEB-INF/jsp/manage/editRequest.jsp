...
<fieldset>
<legend>Edit Change Request</legend> 
<form:hidden path="actionType"/>
	<table border="0">
		<tr>
			<td class="fieldlabel">Request Id<font color=red>*</font></td>
			<td><form:input path="requestId" size="20" maxlength="20" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="fieldlabel">Request Status</td>
			<td><form:select path="status" items="${requestStatus}" itemLabel="value" itemValue="key" /></td>
		</tr>
	</table>
