...
import ca.cihi.cims.service.TransformationServiceImpl;

/**
 * @author wxing
 */
public class TabularTransformReportControllerTest {
	private TabularTransformReportController controller;
	...
	@Mock
	private TransformationServiceImpl transformService;
	...
	public void setUp() throws Exception {
		...
		controller = new TabularTransformReportController();
	...
	public void testBack() {
		...
		assertSame(mav.getViewName(), "redirect:/tabularDataTransformation.htm");
	}
	...
	public void testSetupForm() {
		...
		ModelAndView mav = controller.setupForm(model, Constants.CLASSIFICATION_ICD10CA, FISCAL_2009, "", request,
				session);
		assertSame(mav.getViewName(), "/migration/tabularTransformationReport");
	}
