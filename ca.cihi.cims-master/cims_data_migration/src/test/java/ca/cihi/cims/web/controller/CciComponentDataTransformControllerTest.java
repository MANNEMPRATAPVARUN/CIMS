...
public class CciComponentDataTransformControllerTest {

	private static final Log LOGGER = LogFactory.getLog(CciComponentDataTransformControllerTest.class);
	private CciComponentDataTrasformController controller;
	...
	public void setUp() throws Exception {
		...
		controller = new CciComponentDataTrasformController();
	...
	public void testPopulateClassification() {
		LOGGER.info("Enter CciComponentDataTransformControllerTest.testPopulateClassification()");
	...
	public void testSetupForm() {
		...
		assertSame(mav.getViewName(), "/migration/cciComponentDataTransformation");
	}
	...
	public void testTransformData() {
		...
		when(transformService.getAllCciComponents(null)).thenReturn(null);
	...
	public void testViewTransformationReport() {
		...
		assertSame(mav.getViewName(), "redirect:/cciComponentTransformation.htm");
	}
}
