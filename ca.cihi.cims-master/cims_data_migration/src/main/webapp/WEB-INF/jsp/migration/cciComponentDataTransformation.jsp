...
<jsp:include page="../common/header-menu.jsp">
	<jsp:param name="titleKey" value="cims.menu.transform.ccicomponent.data.header.name"/>
</jsp:include> 

<h3 class="contentTitle"><fmt:message key="cims.title.ccicomponent.transformation" /> </h3> 
<div class="content">
