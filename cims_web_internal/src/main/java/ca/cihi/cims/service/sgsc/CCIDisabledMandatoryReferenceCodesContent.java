...
public class CCIDisabledMandatoryReferenceCodesContent extends SupplementContentGenerator {
	...
	public String generateSupplementContent(SupplementContentRequest request) {
		...
		List<CCIReferenceAttribute> newCodes = getSgscMapper().findCCIDisabledMandatoryReferenceCodes(params);
