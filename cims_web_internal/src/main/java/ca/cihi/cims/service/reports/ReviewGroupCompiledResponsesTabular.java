...
public class ReviewGroupCompiledResponsesTabular extends ReportGenerator {

	private static final Log LOGGER = LogFactory.getLog(ReviewGroupCompiledResponsesTabular.class);
	...
	public Map<String, Object> generatReportData(ReportViewBean reportViewBean) {
		...
		LOGGER.info("ReviewGroupCompiledResponsesTabular.generatReportData()> params.get('patternTopic')=" + params.get("patternTopic"));
		...
		LOGGER.info("ReviewGroupCompiledResponsesTabular.generatReportData()> questionForReviewers.size()=" + questionForReviewers.size());
