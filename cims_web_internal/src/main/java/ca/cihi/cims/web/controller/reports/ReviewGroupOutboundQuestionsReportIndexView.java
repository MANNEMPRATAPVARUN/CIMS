...
public class ReviewGroupOutboundQuestionsReportIndexView extends CIMSBaseExcelView {

	public ReviewGroupOutboundQuestionsReportIndexView(){
		super();
		setUrl(TEMPLATE_URL);
	}
	...
	private static final String TEMPLATE_URL = "classpath:/report/ReviewGroupOutboundQuestionsIndexReportTemplate";

	private static final String SCHEMA_URL = "/report/ReviewGroupOutboundQuestionsIndexReportSchema.xml";

	public static final String REPORT_FILE_NAME = "ReviewGroupOutboundQuestionsIndexReport.xls";
