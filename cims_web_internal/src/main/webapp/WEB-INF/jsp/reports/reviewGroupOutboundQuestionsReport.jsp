...
<fieldset>
<legend>Review Group Outbound Questions</legend>
...
<c:if test="${not empty reportDetail}">  
  <c:choose>
	...
	<display:column sortable="true" titleKey="cims.reports.reviewgroup.outbound.questions.changerequestid" sortProperty="changeRequestId" 
...
<%--
	<display:column sortable="true" titleKey="cims.reports.reviewgroup.outbound.questions.questionid" sortProperty="questionForReviewerId" 
	                headerClass="tableHeader" style="word-wrap:break-word; width:7%;">
			${reportDetail.questionForReviewerId}
	</display:column>
--%>
 
	<display:column sortable="false" titleKey="cims.reports.reviewgroup.outbound.questions.question" 
	                headerClass="tableHeader" style="word-wrap:break-word; width:35%;">
			${reportDetail.questionForReviewerTxt}
	</display:column>

	<display:column sortable="false" titleKey="cims.reports.reviewgroup.outbound.questions.reviewerinput" 
	                headerClass="tableHeader" style="word-wrap:break-word; width:35%;">
			&nbsp;
	</display:column>
