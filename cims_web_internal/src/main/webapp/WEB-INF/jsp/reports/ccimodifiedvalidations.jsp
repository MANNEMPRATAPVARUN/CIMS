...
<script language="JavaScript" type="text/javascript" >
	...
	function download(){
		var validationUrl = '<c:url value="/reports/cciModifiedValidations/validate.htm"/>';
	...
	function changeCurrentYear(currentYear){
		$.ajax({
           	url:"${pageContext.request.contextPath}/reports/findPriorYear.htm?classification=CCI&currentYear="+currentYear,
...
<h4 class="contentTitle">Reports > CCI Modified Validations Report</h4> 

<div class="content">

<form:form method="POST" modelAttribute="reportViewBean" id="viewForm">
	<form:hidden path="classification"/>
	<input type="hidden" name="reportType" value="CCIModifiedValidations"/>
	<ul class="errorMsg" id="errorMessages"></ul>
<fieldset id="reportCriteria">
   <legend>CCI Modified Validations Report</legend>
   <fieldset>
	 	<table>	
		<tr>
