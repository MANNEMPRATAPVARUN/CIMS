...
<body>
<h2 style="text-align:center;">CCI Reference Attributes</h2>
<div class="content">
	...
	<display:table name="referenceAttributes" id="attributeTable" defaultsort="1" requestURI=""
		...
		<display:column sortable="true" titleKey="attribute.mandatory" headerClass="tableHeader sizeEighty" style="text-align:center;">
			${cims:capitalizeFully(attributeTable.mandatory)}
		</display:column>
