...
public class CCINewMandatoryRefValueContentTest {

	CCINewMandatoryReferenceCodesContent content = null;
	...
	public void setup() {
		...
		content = new CCINewMandatoryReferenceCodesContent();
		...
		when(sgscMapper.findCCINewMandatoryReferenceCodes(params)).thenReturn(mockResults());
		...
		when(sgscMapper.findCCINewMandatoryReferenceCodes(paramsFRA)).thenReturn(mockResults());
	}

	@Test
	public void testGenerateContent() {
		SupplementContentRequest request = new SupplementContentRequest(
				SupplementContentRequest.SRC.CCINEWREFVALUE.getSrc(), "ENG", null, null, null, 2l, 1l);
		...
		SupplementContentRequest requestFRA = new SupplementContentRequest(
				SupplementContentRequest.SRC.CCINEWREFVALUE.getSrc(), "FRA", null, null, null, 2l, 1l);
