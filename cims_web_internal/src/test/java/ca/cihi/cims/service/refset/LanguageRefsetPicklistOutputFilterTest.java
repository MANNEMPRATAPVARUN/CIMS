...
public class LanguageRefsetPicklistOutputFilterTest {
    /**
    ...
    public void testGetAvailableRefsetOutput() {
        ...
        List<PicklistOutputDTO> filteredRefsetOutputList = new LanguageRefsetPicklistOutputFilter()
