...
public class ICDDisabledCodeContentTest {
	ICDDisabledCodeContent content = null;
	...
	public void setup(){
		...
		content = new ICDDisabledCodeContent();
		...
		when(sgscMapper.findICDDisabledCodes(paramMap)).thenReturn(mockResult());
	}
	...
	public void testGeneratorContent(){
		SupplementContentRequest request = new SupplementContentRequest(SupplementContentRequest.SRC.ICDDISABLEDCODE.getSrc(), Language.ENGLISH.getCode(), 0l, null, null, 2l, 1l);
